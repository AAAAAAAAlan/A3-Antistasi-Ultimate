...
["name", "Ukrainian Insurgent Army"] call _fnc_saveToTemplate;

["flag", "Flag_FIA_F"] call _fnc_saveToTemplate;
["flagTexture", QPATHTOFOLDER(Templates\Templates\IFA\flag_ukraine_insurgent_army_co.paa)] call _fnc_saveToTemplate;
...
private _initialRebelEquipment = [
    ...
    "lib_shg24",
    "V_LIB_WP_OfficerVest","V_LIB_WP_Kar98Vest","V_LIB_WP_MP40Vest","vest_upa_kar98","vest_upa_mgunner_01","vest_upa_mp40","vest_upa_mp44","vest_upa_officer_belt","vest_upa_private_belt","vest_upa_officer_01","vest_upa_sniper_01",
